...
public class Display {
	...
	Connection con =null;
	public void selectStudentData( String LastName,String FirstName,String Address,String City)
	{
		try {
			...
			ps=con.prepareStatement("select into stud_info (LastName,FirstName,Address,City)Values(?,?,?,?) ");
			...
			System.out.println(" Record display....."+i);
